...
public partial class TLEM_LOGICIEL_EDITEUR_MODELES_GridComponent
{
    #region Parameters
    /// <summary>
    ...
    private OrkaGenericGridComponent<TLEM_LOGICIEL_EDITEUR_MODELES> Ref_TLEM_LOGICIEL_EDITEUR_MODELES;
