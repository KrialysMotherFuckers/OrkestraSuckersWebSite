...
internal class TokenService : ITokenService
{
    ...
    public async ValueTask<TokenResponse> GetTokenAsync(TokenRequest request, string ipAddress, CancellationToken cancellationToken)
    {
    ...
    public async ValueTask<TokenResponse> RefreshTokenAsync(RefreshTokenRequest request, string ipAddress)
    {
    ...
    private async ValueTask<TokenResponse> GenerateTokensAndUpdateUser(ApplicationUser user, string ipAddress)
    {
    ...
    private IEnumerable<Claim> GetClaims(ApplicationUser user, string ipAddress) =>
        new List<Claim>
        {
            ...
            new(OrkaClaims.Fullname, $"{user.FirstName} {user.LastName}"),
            new(ClaimTypes.Name, user.FirstName ?? string.Empty),
            new(ClaimTypes.Surname, user.LastName ?? string.Empty),
            new(OrkaClaims.IpAddress, ipAddress),
            //new(OrkaClaims.Tenant, _currentTenant!.Id),
            new(OrkaClaims.ImageUrl, user.ImageUrl ?? string.Empty),
