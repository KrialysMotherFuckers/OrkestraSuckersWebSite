...
namespace Krialys.Orkestra.Web.Common;

public static class ApiHelper
{
    public static async Task<T> ExecuteCallGuardedAsyncWtihValueTask<T>(
        Func<ValueTask<T>> call,
        ISnackbar snackbar,
    ...
    public static async Task<bool> ExecuteCallGuardedAsyncWtihValueTask(
        Func<ValueTask> call,
        ISnackbar snackbar,
        CustomValidation customValidation = null,
        string successMessage = null)
