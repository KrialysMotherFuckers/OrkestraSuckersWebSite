...
namespace Krialys.Data.EF.Migrations
{
    ...
    [Migration("20240207190140_Initial")]
            ...
            modelBuilder.Entity("Krialys.Data.EF.RefManager.TM_RFS_ReferentialSettings", b =>
                {
                    ...
                    b.Property<string>("Rfs_ErrorMessage")
                        .HasColumnType("TEXT")
                        .HasColumnName("rfs_error_message");
                    ...
                    b.Property<int?>("Rfs_RequestId")
                        .HasColumnType("int")
                        .HasColumnName("rfs_request_id");
            ...
            modelBuilder.Entity("Krialys.Data.EF.RefManager.TM_RFS_ReferentialSettings", b =>
                {
                    b.HasOne("Krialys.Data.EF.RefManager.TR_CNX_Connections", "TR_CNX_Connections")
                        .WithMany("TM_RFS_ReferentialSettings")
