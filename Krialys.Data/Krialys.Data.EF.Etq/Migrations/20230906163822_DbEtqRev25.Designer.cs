...
namespace Krialys.Entities.Migrations
{
    ...
    [Migration("20230906163822_DbEtqRev25")]
    partial class DbEtqRev25
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Krialys.Data.EF.Entities.ETQ_TR_RMC_Ref_Manager_Connections", b =>
                {
                    b.Property<int>("rcs_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("rms_database_login")
                        .HasColumnType("TEXT");

                    b.Property<string>("rms_database_name")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("rms_database_password")
                        .HasColumnType("TEXT");

                    b.Property<int>("rms_database_type")
                        .HasColumnType("int");

                    b.Property<string>("rms_server")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.HasKey("rcs_id");

                    b.ToTable("ETQ_TR_RMC_Ref_Manager_Connections");
                });

            modelBuilder.Entity("Krialys.Data.EF.Entities.ETQ_TR_RMS_Ref_Manager_Settings", b =>
                {
                    b.Property<int>("rms_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("rms_created_by")
                        .HasColumnType("TEXT");

                    b.Property<DateTime>("rms_creation_date")
                        .HasColumnType("datetime");

                    b.Property<string>("rms_description")
                        .HasColumnType("TEXT");

                    b.Property<string>("rms_error_message")
                        .HasColumnType("TEXT");

                    b.Property<bool>("rms_is_active")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("rms_last_refresh_date")
                        .HasColumnType("datetime");

                    b.Property<bool>("rms_referencial_managed_by_labelling")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("rms_send_date_to_gdb")
                        .HasColumnType("datetime");

                    b.Property<string>("rms_table_data")
                        .HasColumnType("TEXT");

                    b.Property<string>("rms_table_data_backup")
                        .HasColumnType("TEXT");

                    b.Property<DateTime?>("rms_table_data_update_date")
                        .HasColumnType("datetime");

                    b.Property<bool>("rms_table_data_updated")
                        .HasColumnType("boolean");

                    b.Property<string>("rms_table_data_updated_by")
                        .HasColumnType("TEXT");

                    b.Property<string>("rms_table_metadata")
                        .HasColumnType("TEXT");

                    b.Property<string>("rms_table_metadata_backup")
                        .HasColumnType("TEXT");

                    b.Property<string>("rms_table_name")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("rms_table_sql_request")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("rms_update_by")
                        .HasColumnType("TEXT");

                    b.Property<DateTime?>("rms_update_date")
                        .HasColumnType("datetime");

                    b.Property<bool>("rms_update_to_send_to_gdb")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("ETQ_TR_RMS_Ref_Manager_Settings");
                });

            modelBuilder.Entity("Krialys.Data.EF.Etq.ETQ_TM_AET_Authorization", b =>
                {
                    b.Property<int>("aet_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("aet_comments")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT");

                    b.Property<int>("aet_etiquette_id")
                        .HasColumnType("int");

                    b.Property<DateTime>("aet_initializing_date")
                        .HasColumnType("datetime");

                    b.Property<string>("aet_initializing_user_id")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("aet_status_id")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("aet_update_by")
                        .HasColumnType("TEXT");

                    b.Property<DateTime?>("aet_update_date")
                        .HasColumnType("datetime");

                    b.Property<string>("aet_user_id")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.HasKey("aet_id");

                    b.HasIndex(new[] { "aet_etiquette_id", "aet_user_id" }, "IDX_ETQ_TM_AET_Authorization")
                        .IsUnique();

                    b.ToTable("ETQ_TM_AET_Authorization");
                });
            ...
            modelBuilder.Entity("Krialys.Data.EF.Etq.TETQ_ETIQUETTES", b =>
                {
                    ...
                    b.Property<bool>("etq_is_public_access")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Etq.TPRCP_PRC_PERIMETRES", b =>
                {
                    ...
                    b.Property<bool>("TPRCP_ALLOW_DTS_ACCESS")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Etq.VACCGET_ACCUEIL_GRAPHE_ETQS", b =>
                {
                    b.Property<string>("PERIODE")
                        .HasColumnType("TEXT");

                    b.Property<int>("NB_ETQ")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToView("VACCGET_ACCUEIL_GRAPHE_ETQS", (string)null);
                });

            modelBuilder.Entity("Krialys.Data.EF.Entities.ETQ_TR_RMS_Ref_Manager_Settings", b =>
                {
                    b.HasOne("Krialys.Data.EF.Entities.ETQ_TR_RMC_Ref_Manager_Connections", "ETQ_TR_RMC_Ref_Manager_Connections")
                        .WithMany()
                        .HasForeignKey("rcs_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ETQ_TR_RMC_Ref_Manager_Connections");
                });

            modelBuilder.Entity("Krialys.Data.EF.Etq.ETQ_TM_AET_Authorization", b =>
                {
                    b.HasOne("Krialys.Data.EF.Etq.TETQ_ETIQUETTES", "TETQ_ETIQUETTE")
                        .WithMany("ETQ_TM_AET_Authorization")
                        .HasForeignKey("aet_etiquette_id")
            ...
            modelBuilder.Entity("Krialys.Data.EF.Etq.TETQ_ETIQUETTES", b =>
                {
                    b.Navigation("ETQ_TM_AET_Authorization");
