...
namespace Krialys.Entities.Migrations.ETQ
{
    ...
    [Migration("20220201173433_DbEtqRev09")]
    partial class DbEtqRev09
    {
            ...
            modelBuilder.Entity("Krialys.Data.EF.Etq.TETQR_ETQ_REGLES", b =>
                {
                    ...
                    b.HasIndex(new[] { "TETQ_ETIQUETTEID", "TRGLRV_REGLES_VALEURID" }, "UK_TETQR_ETQ_REGLES")
                        .IsUnique();
            ...
            modelBuilder.Entity("Krialys.Data.EF.Etq.TOBJR_OBJET_REGLES", b =>
                {
                    ...
                    b.Property<string>("TOBJR_VALEUR")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Etq.TPRS_PROCESSUS", b =>
                {
                    ...
                    b.Property<DateTime>("TPRS_DATE_CREATION")
                        .HasColumnType("TEXT");
