...
public partial class DbUnivers_31 : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.AddColumn<string>(
            name: "TD_IGNORE_RESULT",
            table: "TD_DEMANDES",
            type: "TEXT",
            maxLength: 1,
            nullable: true);
        ...
        migrationBuilder.Sql(@"Update TD_DEMANDES set TD_SUSPEND_EXECUTION ='N',TD_IGNORE_RESULT='N';");
