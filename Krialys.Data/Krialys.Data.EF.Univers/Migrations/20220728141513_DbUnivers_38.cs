...
public partial class DbUnivers_38 : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(@"DROP VIEW IF EXISTS VDE_DEMANDES_ETENDUES;");
        // jointure avec scenario maintenant en left join 
        ...
        migrationBuilder.Sql(@"CREATE VIEW VDE_DEMANDES_ETENDUES AS
		    ...
		    tdd.TD_IGNORE_RESULT,
                ...
                tdd.TSRV_SERVEURID,
                serveur.TSRV_NOM,
                tuReferent.TRU_FIRST_NAME || ' ' || tuReferent.TRU_NAME as REFERENT,
                tuReferentTech.TRU_FIRST_NAME || ' ' || tuReferentTech.TRU_NAME as REFERENT_TECH,
                tdd.TS_SCENARIOID,
                tdd.TE_ETATID,
                tdd.TPF_PLANIF_ORIGINEID,
                tdd.TRU_DEMANDEURID,
                tu.TRU_FIRST_NAME || ' ' || tu.TRU_NAME as DEMANDEUR,
