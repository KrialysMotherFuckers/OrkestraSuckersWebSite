...
namespace Krialys.Entities.Migrations
{
    ...
    [Migration("20240219125238_DbUnivers_60")]
    partial class DbUnivers_60
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TCMD_DOC_DOCUMENTS", b =>
                {
                    ...
                    b.Property<int?>("TCMD_DOC_TAILLE")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TCMD_PH_PHASES", b =>
                {
                    ...
                    b.Property<int?>("TCMD_PH_DELAI_RECYCLAGE")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TEM_ETAT_MASTERS", b =>
                {
                    ...
                    b.Property<string>("TRST_STATUTID_OLD")
                        .HasMaxLength(3)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TM_LIC_Licence", b =>
                {
                    b.Property<int>("lic_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("lic_customer_code")
                        .HasColumnType("TEXT");

                    b.Property<string>("lic_customer_email")
                        .HasColumnType("TEXT");

                    b.Property<DateTime>("lic_expiration_date")
                        .HasColumnType("datetime");

                    b.Property<bool>("lic_is_active")
                        .HasColumnType("boolean");

                    b.Property<DateTime>("lic_issued_date")
                        .HasColumnType("datetime");

                    b.Property<string>("lic_issued_to")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("lic_licence_key")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<int>("lic_licence_type")
                        .HasColumnType("INTEGER");

                    b.Property<string>("lic_product_name")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.HasKey("lic_id");

                    b.ToTable("TM_LIC_Licence");
                });
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TR_LNG_Languages", b =>
                {
                    b.Property<string>("lng_code")
                        .HasMaxLength(3)
                        .HasColumnType("TEXT");

                    b.Property<Guid>("lng_id")
                        .HasColumnType("TEXT");

                    b.Property<bool>("lng_is_preferred_language")
                        .HasColumnType("INTEGER");

                    b.Property<string>("lng_label")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.HasKey("lng_code");

                    b.ToTable("TR_LNG_Languages");
                });

            modelBuilder.Entity("Krialys.Data.EF.Univers.TR_MEL_EMail_Templates", b =>
                {
                    b.Property<Guid>("mel_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("mel_additional_code")
                        .HasColumnType("TEXT");

                    b.Property<string>("mel_code")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("mel_comments")
                        .HasColumnType("TEXT");

                    b.Property<string>("mel_created_by")
                        .HasColumnType("TEXT");

                    b.Property<DateTime>("mel_creation_date")
                        .HasColumnType("datetime");

                    b.Property<string>("mel_description")
                        .HasColumnType("TEXT");

                    b.Property<string>("mel_email_body")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("mel_email_footer")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("mel_email_importance")
                        .HasMaxLength(1)
                        .HasColumnType("TEXT");

                    b.Property<string>("mel_email_recipients")
                        .HasColumnType("TEXT");

                    b.Property<string>("mel_email_recipients_in_bcc")
                        .HasColumnType("TEXT");

                    b.Property<string>("mel_email_recipients_in_cc")
                        .HasColumnType("TEXT");

                    b.Property<string>("mel_email_subject")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("mel_update_by")
                        .HasColumnType("TEXT");

                    b.Property<DateTime?>("mel_update_date")
                        .HasColumnType("datetime");

                    b.Property<string>("sta_code")
                        .HasMaxLength(3)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex(new[] { "mel_code" }, "IX_TMT_CODE$TR_MEL_EMail_Templates");

                    b.ToTable("TR_MEL_EMail_Templates");
                });

            modelBuilder.Entity("Krialys.Data.EF.Univers.TR_WST_WebSite_Settings", b =>
                {
                    b.Property<int>("Wst_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasColumnName("wst_id");

                    b.Property<string>("Wst_Code")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT")
                        .HasColumnName("wst_code");

                    b.Property<string>("Wst_Description")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT")
                        .HasColumnName("wst_description");

                    b.Property<string>("Wst_Label")
                        .HasColumnType("TEXT")
                        .HasColumnName("wst_label");

                    b.Property<string>("Wst_Value")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("TEXT")
                        .HasColumnName("wst_value");

                    b.HasKey("Wst_id");

                    b.ToTable("TR_WST_WebSite_Settings");
                });
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TRU_USERS", b =>
                {
                    b.HasOne("Krialys.Data.EF.Univers.TR_LNG_Languages", "TR_LNG_Languages")
                        .WithMany("TRU_USERS")
                    ...
                    b.Navigation("TR_LNG_Languages");
                });

            modelBuilder.Entity("Krialys.Data.EF.Univers.TR_MEL_EMail_Templates", b =>
                {
                    b.HasOne("Krialys.Data.EF.Univers.TR_LNG_Languages", "TR_LNG_Languages")
                        .WithMany("TR_MEL_EMail_Templates")
                        .HasForeignKey("lng_code");

                    b.HasOne("Krialys.Data.EF.Univers.TRST_STATUTS", "TRST_STATUT")
                        .WithMany("TR_MEL_EMail_Templates")
                        .HasForeignKey("sta_code");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TRST_STATUTS", b =>
                {
                    ...
                    b.Navigation("TR_MEL_EMail_Templates");
