...
namespace Krialys.Entities.Migrations
{
    ...
    [Migration("20210302233237_InitialDbUniversSQLiteCreation")]
    partial class InitialDbUniversSQLiteCreation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TC_CATEGORIES", b =>
                {
                    ...
                    b.HasKey("TC_CATEGORIEID", "TP_PERIMETREID");

                    b.HasIndex(new[] { "TP_PERIMETREID" }, "IX_TC_CATEGORIES_TP_PERIMETREID");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TD_DEMANDES", b =>
                {
                    ...
                    b.Property<string>("TD_FULL_RESULT_FILE_PATH")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TEB_ETAT_BATCHS", b =>
                {
                    ...
                    b.Property<string>("TEB_NOM_TECHNIQUE")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TEL_ETAT_LOGICIELS", b =>
                {
                    ...
                    b.HasKey("TE_ETATID", "TL_LOGICIELID");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TEM_ETAT_MASTERS", b =>
                {
                    ...
                    b.HasIndex("TC_CATEGORIEID", "TP_PERIMETREID");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TE_ETATS", b =>
                {
                    ...
                    b.Property<int?>("TE_LEVEL_IMPORTANCE")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("TE_NOM_TECHNIQUE")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TRCLI_CLIENTAPPLICATIONS", b =>
                {
                    b.Property<int>("TRCLI_APPLICATIONID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("TRCLI_LIB")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT");

                    b.Property<string>("TRCLI_STATUT")
                        .HasMaxLength(1)
                        .HasColumnType("TEXT");

                    b.HasKey("TRCLI_APPLICATIONID");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TRCL_CLAIMS", b =>
                {
                    ...
                    b.Property<string>("TRCL_CLAIM_DESCRIPION")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TRUCL_UTILISATEURS_CLAIMS", b =>
                {
                    b.Property<int>("TRUCL_UTILISATEUR_CLAIMID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("TRU_UTILISATEURID")
                        .HasMaxLength(36)
                        .HasColumnType("TEXT");

                    b.HasKey("TRUCL_UTILISATEUR_CLAIMID");

                    b.HasIndex("TRCL_CLAIMID");

                    b.HasIndex("TRU_UTILISATEURID", "TRCL_CLAIMID")
                        .IsUnique()
                        .HasDatabaseName("UQ_TRUCL_UTILISATEURS_CLAIMS");

                    b.ToTable("TRUCL_UTILISATEURS_CLAIMS");
                });

            modelBuilder.Entity("Krialys.Data.EF.Univers.TRU_UTILISATEURS", b =>
                {
                    b.Property<string>("TRU_UTILISATEURID")
                        .HasMaxLength(36)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("TRU_STATUT")
                        .HasMaxLength(1)
                        .HasColumnType("TEXT");

                    b.HasKey("TRU_UTILISATEURID");

                    b.ToTable("TRU_UTILISATEURS");
                });
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TTAU_AUTHENTIFICATIONS", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("TTAU_AUTH_CODE_EXP")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTimeOffset>("TTAU_REFRESH_TOKEN_EXP")
                        .HasColumnType("TEXT");

                    b.HasKey("TTAU_AUTHENTIFICATIONID");

                    b.HasIndex("TRU_UTILISATEURID");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TC_CATEGORIES", b =>
                {
                    b.HasOne("Krialys.Data.EF.Univers.TP_PERIMETRES", "TP_PERIMETRE")
                        .WithMany("TC_CATEGORIES")
                        .HasForeignKey("TP_PERIMETREID")
                        .HasConstraintName("FK_TC_CATEGORIES$TP_PERIMETRES")
                        .IsRequired();
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TEM_ETAT_MASTERS", b =>
                {
                    ...
                    b.HasOne("Krialys.Data.EF.Univers.TC_CATEGORIES", "T")
                        .WithMany("TEM_ETAT_MASTERS")
                        .HasForeignKey("TC_CATEGORIEID", "TP_PERIMETREID")
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TRUCL_UTILISATEURS_CLAIMS", b =>
                {
                    b.HasOne("Krialys.Data.EF.Univers.TRCL_CLAIMS", "TRCL_CLAIM")
                        .WithMany("TRUCL_UTILISATEURS_CLAIMS")
                        .HasForeignKey("TRCL_CLAIMID")
                        .HasConstraintName("FK_TRUCL_UTILISATEURS_CLAIMS_TRCL_CLAIMS")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Krialys.Data.EF.Univers.TRU_UTILISATEURS", "TRU_UTILISATEUR")
                        .WithMany("TRUCL_UTILISATEURS_CLAIMS")
                        .HasForeignKey("TRU_UTILISATEURID")
                        .HasConstraintName("FK_TRUCL_UTILISATEURS_CLAIMS_TRU_UTILISATEURS");

                    b.Navigation("TRCL_CLAIM");

                    b.Navigation("TRU_UTILISATEUR");
                });
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TTAU_AUTHENTIFICATIONS", b =>
                {
                    b.HasOne("Krialys.Data.EF.Univers.TRU_UTILISATEURS", "TRU_UTILISATEUR")
                        ...
                        .HasForeignKey("TRU_UTILISATEURID")
                        .HasConstraintName("FK_TTAU_AUTHENTIFICATIONS_TRU_UTILISATEURS");
            ...
            modelBuilder.Entity("Krialys.Data.EF.Univers.TRCL_CLAIMS", b =>
                {
                    ...
                    b.Navigation("TRUCL_UTILISATEURS_CLAIMS");
                });
